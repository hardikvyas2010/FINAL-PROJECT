      ...
      <?php foreach ($linear->days as $day) {
          ...
          if (strstr($day->display, ';')) {
              ...
              $statuses = explode(";", $day->status);
                ...
                {
                    case 1: $class = "planned"; break;  
                    case 2: $class = "requested"; break; 
                    case 3: $class = "accepted"; break;  
                    case 4: $class = "rejected"; break;  
            ...
            switch ($day->display) {
                ...
                case '1':
                      switch ($day->status)
                      {
                          case 1: $class = "allplanned"; break; 
                          case 2: $class = "allrequested"; break;  
                          case 3: $class = "allaccepted"; break;  
                          case 4: $class = "allrejected"; break;  
                      }
                      break;
                case '2':
                    switch ($day->status)
                      {
                          case 1: $class = "amplanned"; break;  
                          case 2: $class = "amrequested"; break; 
                          case 3: $class = "amaccepted"; break;  
                          case 4: $class = "amrejected"; break; 
                      }
                    break;
                case '3':
                    switch ($day->status)
                      {
                          case 1: $class = "pmplanned"; break;  
                          case 2: $class = "pmrequested"; break; 
                          case 3: $class = "pmaccepted"; break;  
                          case 4: $class = "pmrejected"; break; 
                      }
                    break;
            }
          }
